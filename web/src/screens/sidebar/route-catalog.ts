...
export const MAC_SIDEBAR_TOOL_ENTRIES: RouteCatalogEntry[] = [
  ...
  { route: "calendar", label: "Calendar", section: "tools", macToolId: "calendar", macRoute: "calendarHome", webSurface: "implemented" },
  { route: "contacts", label: "Contacts", section: "tools", macToolId: "contacts", macRoute: "contactsHome", webSurface: "implemented" },
  ...
  { route: "mac-care", label: "Mac Care", section: "tools", macToolId: "macCare", macRoute: "macCare", webSurface: "implemented" },
  { route: "marketplace", label: "Marketplace", section: "tools", macToolId: "marketplace", macRoute: "marketplaceHome", webSurface: "implemented" },
