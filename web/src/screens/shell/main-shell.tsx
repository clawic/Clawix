...
import { MacCareView } from "../mac-care/mac-care-view";
import { MarketplaceView } from "../marketplace/marketplace-view";
    ...
    <div className="h-full sidebar-backdrop relative">
      ...
      <div className="h-full flex">
        ...
        <ContentShell rightSidebarOpen={rightSidebarOpen}>
          ...
          {route === "drive" && <DriveView view="drive" />}
          {route === "photos" && <DriveView view="photos" />}
          {route === "documents" && <DriveView view="documents" />}
          {route === "recent" && <DriveView view="recent" />}
          {route === "agents" && <AgentFamilyView view="agents" />}
