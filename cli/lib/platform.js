...
const BRIDGE_STATUS_DID_CHANGE_NOTIFICATION = 'com.clawix.bridge.status.didChange';
const BRIDGE_FALLBACK_HEARTBEAT_SECONDS = 30;
...
module.exports = {
  ...
  BRIDGE_PORT,
  BRIDGE_HTTP_PORT,
  BRIDGE_STATUS_DID_CHANGE_NOTIFICATION,
  BRIDGE_FALLBACK_HEARTBEAT_SECONDS,
