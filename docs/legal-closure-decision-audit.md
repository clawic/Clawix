...
| LCA-027 | Provider terms | User chooses/assumes | Terms/Privacy/EULA place chosen third-party providers under their own terms; provider-backed dictation enhancement and cloud STT now skip external provider clients unless the local provider disclosure opt-in is enabled. | Provider UI must keep disclosure/opt-in. |
