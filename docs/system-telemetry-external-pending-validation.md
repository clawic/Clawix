...
| CLX-SYS-TEL-EXT-006 | Rendered graph view over retained telemetry | The framework Monitor store retains samples, rollups, and incidents; Clawix has a recorder path into that store. | Current Clawix graph surface wired to Monitor history and inspected with representative retained telemetry. | EXTERNAL PENDING |
