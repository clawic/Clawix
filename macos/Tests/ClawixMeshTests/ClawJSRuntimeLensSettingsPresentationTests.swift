...
final class ClawJSRuntimeLensSettingsPresentationTests: XCTestCase {
    ...
    func testSettingsPresentationShowsOfficialSnapshotRows() async throws {
        ...
        XCTAssertTrue(details.contains("Drift policy: hermes_operable_non_default_until_final_production_recommended_policy"))
        ...
        XCTAssertTrue(sessionClosure.detailLines.contains("implemented facets manifest_domain_contract, claw_cli_resource_surface, read_projection_contract, local_overlay_reconciliation_policy"))
        ...
        XCTAssertTrue(sessionAuditDomain.detailLines.contains("evidence dispositions blocked_until_official_runtime_contract, blocked_until_official_runtime_action_contract, blocked_until_tui_gateway_wrapper_fixture, local_overlay_until_official_runtime_write_back_contract"))
        XCTAssertTrue(sessionAuditDomain.detailLines.contains("evidence hermes.sessions.write_back_contract, hermes.sessions.preview.action_contract, hermes.sessions.resolve.action_contract, hermes.sessions.history.action_contract, +6 more"))
