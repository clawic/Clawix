...
final class ClawJSRuntimeLensClientTests: XCTestCase {
    ...
    func testRuntimeLensDecodesHermesRuntimePortalEnvelope() async throws {
        ...
        XCTAssertEqual(snapshot.commands?.jsonPortalCommandSet?.supportStage, "dev_only")
        ...
        XCTAssertEqual(snapshot.supportAudit?.commandCoverageSummary?.supportStage, "dev_only")
