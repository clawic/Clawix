...
final class AppCustomSurfaceCapabilityCatalogTests: AppCustomSurfaceCapabilityTestCase {
    ...
    func testOrdinaryReadCapabilitiesExposeSharedRedactionPolicy() {
        ...
        XCTAssertEqual(AppCapabilityCatalog.descriptor(id: "system.telemetry.snapshot")?.maturity, .experimental)
        XCTAssertEqual(AppCapabilityCatalog.descriptor(id: "system.telemetry.snapshot")?.activationPolicy, .optIn)
        XCTAssertEqual(AppCapabilityCatalog.descriptor(id: "system.telemetry.history")?.maturity, .experimental)
        XCTAssertEqual(AppCapabilityCatalog.descriptor(id: "system.telemetry.history")?.activationPolicy, .optIn)
