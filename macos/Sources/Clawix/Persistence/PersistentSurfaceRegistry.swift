...
enum ClawixPersistentSurfaceRegistry {
    ...
    private static var contractSurfaceNodes: [PersistentSurfaceNode] {
        ...
        let envSurfaces = [
            ...
            "CLAWIX_E2E_TEXT_INJECTOR_CAPTURE",
    ...
    private static var preferenceSurfaceNodes: [PersistentSurfaceNode] {
        [
            ...
            ("clawix.prefs.appshots.enabled", "Appshots enabled", AppshotSettings.enabledKey, PersistentSurfaceKind.appStorageKey),
            ("clawix.prefs.appshots.hotkey", "Appshots hotkey", AppshotSettings.hotkeyKey, PersistentSurfaceKind.appStorageKey),
            ("clawix.prefs.computerUse.anyAppEnabled", "Computer Use any app enabled", ComputerUseSettings.Keys.anyApp, PersistentSurfaceKind.preferenceKey),
            ("clawix.prefs.computerUse.lockedUseEnabled", "Computer Use locked use persisted policy", ComputerUseSettings.Keys.lockedUse, PersistentSurfaceKind.preferenceKey),
            ("clawix.prefs.computerUse.alwaysAllowedApps", "Computer Use always-allowed apps", ComputerUseSettings.Keys.allowed, PersistentSurfaceKind.preferenceKey),
            ...
            ("clawix.prefs.legal.acceptedTermsVersion", "Legal accepted Terms version", LegalSafetyDefaultsKeys.acceptedTermsVersion, PersistentSurfaceKind.preferenceKey),
            ("clawix.prefs.legal.acceptedPrivacyVersion", "Legal accepted Privacy version", LegalSafetyDefaultsKeys.acceptedPrivacyVersion, PersistentSurfaceKind.preferenceKey),
            ("clawix.prefs.legal.acceptedEULAVersion", "Legal accepted EULA version", LegalSafetyDefaultsKeys.acceptedEULAVersion, PersistentSurfaceKind.preferenceKey),
            ("clawix.prefs.legal.acceptedDisclaimerVersion", "Legal accepted Disclaimer version", LegalSafetyDefaultsKeys.acceptedDisclaimerVersion, PersistentSurfaceKind.preferenceKey),
            ("clawix.prefs.legal.acceptedSafetyVersion", "Legal accepted Safety version", LegalSafetyDefaultsKeys.acceptedSafetyVersion, PersistentSurfaceKind.preferenceKey),
            ("clawix.prefs.legal.acceptedRegulatedDomainsVersion", "Legal accepted Regulated Domains version", LegalSafetyDefaultsKeys.acceptedRegulatedDomainsVersion, PersistentSurfaceKind.preferenceKey),
            ("clawix.prefs.legal.acceptedAt", "Legal acceptance timestamp", LegalSafetyDefaultsKeys.acceptedAt, PersistentSurfaceKind.preferenceKey),
            ("clawix.prefs.legal.adultConfirmed", "Legal adult confirmation", LegalSafetyDefaultsKeys.adultConfirmed, PersistentSurfaceKind.preferenceKey),
            ("clawix.prefs.legal.remoteSyncOptIn", "Legal remote sync opt-in", LegalSafetyDefaultsKeys.remoteSyncOptIn, PersistentSurfaceKind.preferenceKey),
            ("clawix.prefs.legal.providerDisclosureOptIn", "Legal provider disclosure opt-in", LegalSafetyDefaultsKeys.providerDisclosureOptIn, PersistentSurfaceKind.preferenceKey),
            ("clawix.prefs.legal.supportDiagnosticsOptIn", "Legal support diagnostics opt-in", LegalSafetyDefaultsKeys.supportDiagnosticsOptIn, PersistentSurfaceKind.preferenceKey),
            ("clawix.prefs.legal.sensitiveExportConfirmationRequired", "Legal sensitive export confirmation", LegalSafetyDefaultsKeys.sensitiveExportConfirmationRequired, PersistentSurfaceKind.preferenceKey),
            ...
            ("clawix.prefs.browser.agentControlEnabled", "Browser agent control enabled", BrowserPermissionPolicy.agentControlEnabledKey, PersistentSurfaceKind.preferenceKey),
            ("clawix.prefs.browser.annotationScreenshots", "Browser annotation screenshots", BrowserPermissionPolicy.annotationScreenshotsKey, PersistentSurfaceKind.preferenceKey),
            ...
            ("clawix.prefs.dictation.soundFeedback", "Dictation sound feedback", DictationSoundPlayer.defaultsKey, PersistentSurfaceKind.appStorageKey),
            ("clawix.prefs.dictation.playStartSound", "Dictation play start sound", DictationSoundPlayer.playStartKey, PersistentSurfaceKind.appStorageKey),
            ("clawix.prefs.dictation.playStopSound", "Dictation play stop sound", DictationSoundPlayer.playStopKey, PersistentSurfaceKind.appStorageKey),
            ("clawix.prefs.dictation.customStartSound", "Dictation custom start sound", DictationSoundPlayer.customStartURLKey, PersistentSurfaceKind.appStorageKey),
            ("clawix.prefs.dictation.customStopSound", "Dictation custom stop sound", DictationSoundPlayer.customStopURLKey, PersistentSurfaceKind.appStorageKey),
            ...
            ("clawix.prefs.dictation.fillerWordsEnabled", "Dictation filler words enabled", FillerWordsStore.enabledKey, PersistentSurfaceKind.appStorageKey),
            ("clawix.prefs.dictation.fillerWordsList", "Dictation filler words list", FillerWordsStore.listKey, PersistentSurfaceKind.preferenceKey),
            ...
            ("clawix.prefs.dictation.hotkeyMode", "Dictation hotkey mode", DictationHotkeyMonitor.modeDefaultsKey, PersistentSurfaceKind.preferenceKey),
            ("clawix.prefs.dictation.hotkeyTrigger", "Dictation hotkey trigger", DictationHotkeyMonitor.triggerDefaultsKey, PersistentSurfaceKind.preferenceKey),
            ("clawix.prefs.dictation.hotkey2Mode", "Dictation second hotkey mode", DictationHotkeyMonitor.mode2DefaultsKey, PersistentSurfaceKind.preferenceKey),
            ("clawix.prefs.dictation.hotkey2Trigger", "Dictation second hotkey trigger", DictationHotkeyMonitor.trigger2DefaultsKey, PersistentSurfaceKind.preferenceKey),
            ("clawix.prefs.dictation.vocabulary", "Dictation vocabulary", DictationVocabularyStore.defaultsKey, PersistentSurfaceKind.preferenceKey),
            ("clawix.prefs.dictation.powerModeEnabled", "Dictation power mode enabled", PowerModeStore.enabledKey, PersistentSurfaceKind.preferenceKey),
            ("clawix.prefs.dictation.powerModeConfigs", "Dictation power mode configs", PowerModeStore.configsKey, PersistentSurfaceKind.preferenceKey),
