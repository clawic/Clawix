...
/// Lucide `play` glyph, ported 1:1 from the lucide-icons/lucide
...
struct PlayIconShape: Shape {
    func path(in rect: CGRect) -> Path {
        ...
        var path = Path()
        path.addPath(SVGPathBuilder.build("M5 5a2 2 0 0 1 3.008-1.728l11.997 6.998a2 2 0 0 1 .003 3.458l-12 7A2 2 0 0 1 5 19z"), transform: xform)
        return path
    }
}
