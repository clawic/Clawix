...
/// Lucide `panel-top` glyph, path data replicated from the Lucide source
...
struct PanelTopIconShape: Shape {
    func path(in rect: CGRect) -> Path {
        ...
        path.addPath(SVGPathBuilder.build("M3 9h18"), transform: xform)
        return path
    }
}
