...
/// Lucide `bookmark` glyph, path data replicated from the Lucide source
...
struct BookmarkIconShape: Shape {
    func path(in rect: CGRect) -> Path {
        ...
        var path = Path()
        path.addPath(SVGPathBuilder.build("m19 21-7-4-7 4V5a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2v16z"), transform: xform)
        return path
    }
}
