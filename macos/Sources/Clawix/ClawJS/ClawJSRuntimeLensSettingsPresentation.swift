    ...
    private static func reentrySection(_ presentation: ClawJSRuntimeLensEvidenceReentryPresentation) -> Section {
        Section(
            ...
            rows: [
                ...
                Row(id: $0.requirementId, label: $0.requirementId, value: $0.commandShape, pills: $0.approvalRequired ? [Pill(id: "approval", label: "approval", tone: .warning)] : [], detailLines: optionalLines([$0.safeDefault, $0.reentryCondition, $0.expectedEvidenceLabel, $0.riskControlsLabel, $0.claimEffect, $0.supportResolution, $0.productDecision, $0.userVisibleContract]), accessibilityLabel: $0.accessibilityLabel)
            },
            accessibilityLabel: presentation.accessibilityLabel
        )
    }
