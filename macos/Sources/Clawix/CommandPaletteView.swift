...
private enum PaletteCatalog {
    static let sections: [PaletteSection] = [
        ...
        PaletteSection(id: "aplicacion", title: "App", items: [
            ...
            PaletteItem(id: "companion", icon: "sparkles",
                        title: "Toggle companion", shortcut: nil,
                        action: { _ in PetController.shared.toggle() }),
            PaletteItem(id: "perf-trace", icon: "waveform.path.ecg",
                        title: "Record performance trace", shortcut: nil,
                        action: { _ in PerfTraceController.shared.toggle() }),
