...
import {
  ...
  appStudioSurfaces,
  type AppStudioSurfaceId
} from "../lib/app_studio_model";

export default function AppStudioView() {
  const [selected, setSelected] = createSignal<AppStudioSurfaceId>("apps");
  const surface = () => appStudioSurfaceById(selected());

  return (
    <section class="h-full overflow-auto">
      <div class="mx-auto max-w-[720px] px-8 py-10">
        <header class="mb-7">
          <h1 class="text-[22px] font-semibold tracking-tightish">Apps</h1>
          <p class="mt-1 text-sm text-zinc-500">
            Apps and design resources stay in the shared framework workspace contract.
          </p>
        </header>
