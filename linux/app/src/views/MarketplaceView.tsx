...
} from "../lib/marketplace_surface_model";

export default function MarketplaceView() {
  const [selected, setSelected] = createSignal<MarketplaceSurfaceId>("marketplace");
  const surface = () => marketplaceSurfaceById(selected());

  return (
    <section class="h-full overflow-auto">
      <div class="mx-auto max-w-[720px] px-8 py-10">
        <header class="mb-7">
          <h1 class="text-[22px] font-semibold tracking-tightish">Marketplace</h1>
          <p class="mt-1 text-sm text-zinc-500">
            Marketplace, Home/IoT, and Life surfaces stay on framework contracts with external lanes explicit.
          </p>
        </header>
