...
import { dataSurfaceById, dataSurfaces, type DataSurfaceId } from "../lib/data_surface_model";

export default function DataSurfaceView() {
  const [selected, setSelected] = createSignal<DataSurfaceId>("database");
  const surface = () => dataSurfaceById(selected());

  return (
    <section class="h-full overflow-auto">
      <div class="mx-auto max-w-[720px] px-8 py-10">
        <header class="mb-7">
          <h1 class="text-[22px] font-semibold tracking-tightish">Database</h1>
          <p class="mt-1 text-sm text-zinc-500">
            Database, workbench, and index surfaces stay on framework-owned storage contracts.
          </p>
        </header>
