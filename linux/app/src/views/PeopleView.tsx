...
import { peopleSurfaceById, peopleSurfaces, type PeopleSurfaceId } from "../lib/people_surface_model";

export default function PeopleView() {
  const [selected, setSelected] = createSignal<PeopleSurfaceId>("calendar");
  const surface = () => peopleSurfaceById(selected());

  return (
    <section class="h-full overflow-auto">
      <div class="mx-auto max-w-[720px] px-8 py-10">
        <header class="mb-7">
          <h1 class="text-[22px] font-semibold tracking-tightish">People</h1>
          <p class="mt-1 text-sm text-zinc-500">
            Calendar, contacts, and identity surfaces use shared framework records with host permissions explicit.
          </p>
        </header>
