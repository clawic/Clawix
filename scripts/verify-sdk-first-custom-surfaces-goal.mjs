...
function assertCompletionAudit() {
  ...
  for (const snippet of [
    ...
    "exact reviewed protected route target set",
    "exact reviewed protected route policy set",
...
function assertPublicRouting() {
  for (const [relativePath, snippets] of Object.entries({
    ...
    "docs/governance/sdk-first-custom-surfaces/external-evidence.schema.json": [
      ...
      "\"executor\": { \"const\": \"signed_host_native\" }",
      ...
      "\"marketplaceTrustRefs\": { \"type\": \"array\", \"minItems\": 2",
      "\"CLX-SDK-EXT-001\"",
      "\"CLX-SDK-EXT-002\"",
      "\"CLX-SDK-EXT-003\"",
      "\"CLX-SDK-EXT-004\"",
...
function assertTests() {
  ...
  for (const snippet of [
    ...
    "testProtectedRoutePolicySetAndDefaultStayExact",
    "reviewedProtectedRoutePolicyRawValues",
    "\"variantOnly\"",
