...
const expectedDecisions = [
  ["initial_scope", d("Q3Jvc3MtcGxhdGZvcm0gZGVzZGUgZGlhIDE=")],
  ...
  ["canon_approval", d("T0sgaHVtYW5vIGV4cGxpY2l0bw==")],
  ["visual_baselines_location", d("UHJpdmFkbyArIG1hbmlmZXN0cyBwdWJsaWNvcw==")],
  ["canon_unit", d("UGF0cm9uZXMgVUk=")],
  ["agent_ui_workflow", d("Q29uc3VsdGEgKyBjb250cmF0bw==")],
  ["performance_budget_style", d("UG9yIGZsdWpvIGNyaXRpY28=")],
  ["alignment_validation", d("R2VvbWV0cmljYSArIHZpc3VhbA==")],
  ["state_coverage", d("VG9kb3MgbG9zIGludGVyYWN0aXZvcw==")],
  ["human_visual_review", d("UHJvbW92ZXIgY2Fub24=")],
  ["governance_location", d("UmVwbyBDbGF3aXggcHVibGljbw==")],
  ["skills_shape", d("U2tpbGxzIGVzcGVjaWFsaXphZGFz")],
  ["external_references_policy", d("QmlibGlvdGVjYSBkZSBpbnNwaXJhY2lvbg==")],
  ["gate_surface", d("RGV2ICsgdGVzdCArIENJ")],
  ["exception_policy", d("RXhjZXBjaW9uIGNvbiBjYWR1Y2lkYWQ=")],
  ["copy_governance", d("U2ksIGNvbW8gY2Fub24gVUk=")],
